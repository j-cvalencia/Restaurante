...
export const Inicio = () => {
  return (
    <>
      ...
      <Banner videoBanner={'/videos/videoBanner.mp4'} tituloBanner={'Bienvenido a Restaurante Ensigna'} descripcionBanner={'Donde nuestra comida es deliciosa y unica'} textoBTN1={'VER CARTA'} rutaBTN1={'/menú'} textoBTN2={'RESERVAR MESA'} rutaBTN2={'/reserva'}/>
